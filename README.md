...
**Shipped version:** 2.2.0~ynh1 *(:warning: This is the `testing` branch. The [`master` branch](https://github.com/YunoHost-Apps/audiobookshelf_ynh/tree/master) used in the catalog is currently on version 2.1.5\~ynh1.)*
